...
class TransformControls extends Controls {
	...
	attach( object ) {
		...
		// this.object.add(new THREE.Mesh(new THREE.SphereGeometry(4, 32, 16), new THREE.MeshBasicMaterial({color: 0xF00, visible: true})));
		return this;
...
class TransformControlsGizmo extends Object3D {
	...
	constructor() {
		...
		const pickerTranslate = {
			...
			Z: [
				// [ new Mesh( new SphereGeometry( 1, 32, 16), matInvisible ), [ 0, 0, 0 ], [ 0, 0, 0 ]]
